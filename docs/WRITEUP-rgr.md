...
- **⚠ IS DeepSeek CLEAN AT ALL? — the top open item *(new 2026-07-27, Phase 22
  ...
  **excludes zero and makes it a sink**. And the interval reaches −0.0437, past the
  ...
  effect. **[SHARPENED 2026-07-27, Phase 23 §5.1 / §8 entry 16: DeepSeek's artifact leg
  DECISIVELY EXCLUDES ZERO (−0.0124, CI [−0.0215,−0.0041]), so it IS below the copy null.** Its
  clean verdict rests entirely on the **higher-variance i.i.d. leg** — whose CI is 2.56× the
  artifact leg's, the widest ratio in the record. This is not a model that fails to sink; it is
  a model whose sink the noisier leg cannot resolve.]** *What would settle it:* DeepSeek at
  MDE ≈0.020 needs **n ≈ 200**, i.e. a donor pool
